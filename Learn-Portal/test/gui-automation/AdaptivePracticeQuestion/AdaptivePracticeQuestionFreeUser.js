...
describe("Learn Portal - Adaptive Practice Question test - Free user flow", async () => {
    ...
    it("306333 TC_01 Free user- Validate user is able to complete test flow for warm up section", async () => {
    ...
    it("306334 TC_02 Free user- Validate user is able to take all the 6 test ", async () => {
    ...
    it("306335 TC_03 Free user- Validate the book marked question is getting displayed under book mark tab", async () => {
    ...
    it("306336 TC_04 Free user- Validate View solution pop up of bookmarked questions", async () => {
    ...
    it("306337 TC_05 Free user- Validate instruction pop up before starting the test", async () => {
    ...
    it("306338 TC_06 Validate resume test flow and continue to finish the test", async () => {
    ...
    it("306339 TC_07 Validate resume test - end practice flow", async () => {
    ...
    it("306340 TC_08 Free user - Analysis page- validation of analysis the section header", async () => {
    ...
    it("306341 TC_09 Free user - Perfomance statistics section validation", async () => {
    ...
    it("306342 TC_10 Free user - Analysis- Validate No of questions gets increase after taking the test each time ", async () => {
    ...
    it("306343 TC_11 Free user - Analysis - Accuracy Chart toottip validation ", async () => {
    ...
    it("306344 TC_12 Free user - Analysis - Time Spent Chart toottip validation ", async () => {
